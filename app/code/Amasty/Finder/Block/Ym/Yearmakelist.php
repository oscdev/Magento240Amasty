...
namespace Amasty\Finder\Block\Ym;
...
class Yearmakelist  extends \Magento\Framework\View\Element\Template
{
    /**
     * @var Resolver
     */
    ...
    public function getAllFinders()
    {
       ...
       $select = $this->connection->select()->from(
        ...
        $finders['Model']=array_unique($finders['Model']);
